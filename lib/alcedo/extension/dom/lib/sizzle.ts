        ...
        preFilter: {
            ...
            "CHILD": function (match) {
                ...
                if (match[1].slice(0, 3) === "nth") {
                    ...
                    match[4] = +( match[4] ? match[5] + (match[6] || 1) : 2 * Number( match[3] === "even" || match[3] === "odd" ) );
...
// Use getAttributeNode to fetch booleans when getAttribute lies
    ...
    (<any>window).Sizzle = Sizzle;

})(window);

//declare var Sizzle:any = function(selector:HTMLElement|string);