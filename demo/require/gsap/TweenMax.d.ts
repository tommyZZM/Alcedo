...
declare class TweenMax {
    ...
    /** The selector engine (like jQuery) that should be used when a tween receives a string as its target, like TweenMax.to("#myID", 1, {x:"100px"}). */
    ...
    duration(): number;
    duration(value: number): TweenMax;
    ...
    progress(): number;
    progress(value: number, suppressEvents?: boolean): TweenMax;
    ...
    resume(from?: any, suppressEvents?: boolean): TweenMax;
    ...
    totalDuration(value: number): TweenMax;
    ...
    totalProgress(value: number, suppressEvents?: boolean): TweenMax;
    ...
    totalTime(): number;
    totalTime(time: number, suppressEvents?: boolean): TweenMax;
}