...
module game{
    ...
    export class He162S extends LogicObject{
        ...
        public constructor(skin:string){
            ...
            this._display = new alcedo.canvas.MovieClip(alcedo.core(canvas.MovieClipRepository).get("smallalcedo"));
            this._display.scaleALL(0.6)
        ...
        private debugRobot(){
            ...
            if(this.b.y>stage.stageHeight*0.6 && ! this._debugautocontrol){
