...
var example;
(function (example) {
    var BezierExample = (function (_super) {
        __extends(BezierExample, _super);
        function BezierExample() {
            _super.apply(this, arguments);
        }
        BezierExample.prototype.run = function () {
    ...
    example.BezierExample = BezierExample;
    var BezierMaker = (function () {
        ...
        BezierMaker.create = function (points) {
            ...
            return new example.canvas.Bezier2D(curvepoints);
        };
