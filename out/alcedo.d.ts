 ...
 */
declare module alcedo {
    class AppNotifyable extends AppObject {
        protected _notifymap: Dict;
        constructor();
        protected registNotify(notifymap: Dict, name: string, callback: Function, thisObject: any, param?: Array<any>, priority?: number): boolean;
        protected unregistNotify(notifymap: Dict, name: string, callback: Function, thisObject: any): void;
        protected notify(notifymap: Dict, name: string, param?: Array<any>): void;
        static notify(notifymap: Dict, name: string, param?: Array<any>): boolean;
        protected notifyArray(arr: Array<{
            callback: Function;
            thisObject: any;
            param: Array<any>;
 ...
 */
declare module alcedo {
    class EventDispatcher extends AppNotifyable {
 ...
 */
declare module alcedo {
    class AppProxyer extends EventDispatcher {
        constructor();
        protected _inted: boolean;
        init(...anyarg: any[]): void;
...
declare module alcedo {
    module canvas {
        class DisplayObject extends EventDispatcher implements IDisplayObject {
            ...
            pivotX(x?: number): number;
            pivotY(y?: number): number;
            pivotOffsetX(offsetx?: number): number;
            pivotOffsetY(offsety?: number): number;
            scaleToWidth(width: number): void;
            scaleToHeight(height: number): void;
            scaleALL(value: number): void;
            scaleX(scalex?: number): number;
            scaleY(scaley?: number): number;
            /**
             * 碰撞检测,可以被重写
             * @private
             */
...
declare module alcedo {
    var isdebug: boolean;
    function proxy(proxy: any, proxyid?: string): AppProxyer | any;
    function dispatchCmd(command: any, cmd: string, courier?: Array<any>): void;
    function addDemandListener(com: any, type: string, callback: Function, thisObject: any): boolean;
    function addFacadeInitTask(fn: any, thisObject?: any, param?: Array<any>): void;
    class AppFacade extends EventDispatcher {
        static ON_INIT: string;
        private _app;
        private _cmdpool;
        private _proxypool;
        private _postman;
        ...
        app: AppCycler;
        postals: Dict;
        private _postOffice(e);
        private static _proxycound;
        proxy(proxy: any, proxyid?: string): AppProxyer | any;
        /**
         * 获得command的唯一id
         * @type {number}
         * @private
         */
        private static _commandcound;
        static getCommandId(command: any): string;
        private command(command);
        dispatchCmd(command: any, cmd: string, courier?: Array<any>): void;
        addDemandListener(com: any, type: string, callback: Function, thisObject: any): boolean;
 ...
 */
declare module alcedo {
    class AppCmder extends EventDispatcher {
        constructor();
...
declare module alcedo {
    module canvas {
        class CanvasRenderer extends AppProxyer {
            static MainLoop: string;
            protected _stage: Stage;
...
declare module alcedo {
    ...
    class AppLauncher {
        ...
        launch(courier?: any): void;
        private static _instance;
        static instance(debug?: boolean): AppLauncher;
    }
    function launch(debug?: boolean, courier?: any): void;
}
...
declare module alcedo {
     ...
     */
    class AppObjectPool extends AppProxyer {
        private static instanceable;
        private _objectpool;
        constructor();
        new(objclass: any): ICycable;
        destory(obj: ICycable): void;
    }
}
/**
...
declare module alcedo {
    module dom {
        class DomElement extends EventDispatcher {
            ...
            private _lastindex;
            index: string | number;
            to(cssprops: any, transition?: number): DomElement;
            private _rotation;
            rotate(angle: number, transition?: number): DomElement;
            scale(scale: number, transition?: number): DomElement;
            translate(x: number, y: number, transition?: number): DomElement;
            private _lasttransition;
            transition: number;
            then(fn: (_this?: DomElement) => void, waittime_ms?: number): void;
            /**
...
declare module alcedo {
    module net {
        ...
        class AsyncRES extends AppProxyer {
            private static instanceable;
            private _repeatkey;
            private _assetspool;
            constructor();
 ...
 */
declare module alcedo {
    class AppCycler extends AppCmder {
        constructor();
...
declare module alcedo {
    class FacadeEvent extends Event {
        ...
        private _notify;
        constructor();
        setNotify(com: any, notify: string, courier?: any): void;
        com: string;
        notify: string;
    }
}
...
declare module alcedo {
     ...
     * 异步流程控制,beta版
     */
    class AsyncQuener extends AppObject implements ICycable {
        private _querycount;
        private _query;
        constructor();
        private finishmark;
        private prepush(fns);
        private push(fnarr);
        private check2next(index);
        static begin(fns: any): AsyncQuener;
        then(fns: Array<Function> | Function): AsyncQuener;
        private end();
        onCreate(): void;
        onDestory(): void;
    }
...
declare module alcedo {
    module encrypt {
        class SimpleEncode {
            static encode(str: any): Array<number>;
            static decode(_bytes: Array<number>): string;
        }
    }
}
/**
    ...
    module canvas {
        ...
        module graphic {
            class Circle extends DisplayGraphic {
                private _radius;
                constructor(x: number, y: number, r?: number, coulour?: string);
            }
            class Rectangle extends DisplayGraphic {
                constructor(x: number, y: number, width?: number, height?: number, coulour?: string);
            }
        }
    }
}
...
declare module alcedo {
    module canvas {
        class Stage extends DisplatObjectContainer {
            ...
            _enterframe(renderer: any): void;
            enterframe(callback: any, thisOBject: any): void;
            canvas: dom.DomElement;
            gasket: dom.DomElement;
            canvasui: dom.DomElement;
            options: any;
...
declare module alcedo {
    module canvas {
        class ParticleEmitter extends DisplayObject {
             ...
             */
            private _force;
            private _forcemoment;
            applyForce(force: Vector2D, continute?: boolean): void;
...
declare module alcedo {
    module canvas {
        class Camera2D extends AppProxyer {
            private _stage;
            private _position;
            private _focal;
            private _yaw;
...
declare module alcedo {
    module canvas {
        class Ticker extends AppProxyer {
            private _stage;
            private _fps;
...
declare module alcedo {
    module canvas {
        class MovieClipRepository extends AppProxyer {
            private static instanceable;
...
declare module alcedo {
    module canvas {
        class TextureRepository extends AppProxyer {
            private static instanceable;
            static ASSETS_COMPLETE: string;
            static ASSETS_PROGRESSING: string;
            private _repeatkey;
...
declare module alcedo {
    module net {
        ...
        class AsyncProxy extends AppProxyer {
...
declare module alcedo {
    module net {
        class AsyncAssetsLoader extends AppProxyer {
            private static instanceable;
            private _basedir;
            private _thread;
